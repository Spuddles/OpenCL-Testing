...
void RealtimeGraphics::projectPoints(std::vector<Vector4f> &vecPoints, Point<int> eye, float zplane, std::vector<Point<int>> &vecOutput)
{
	for (Vector4f v : vecPoints)
	{
